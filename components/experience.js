...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      points: [
        'Developed and maintained data pipelines using Azure services',
        'Worked with Azure Data Factory and Databricks',
        'Implemented data transformation and analytics solutions',
        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            {experiences.map((exp, index) => (
              <div key={index} className={`relative ${exp.position === 'right' ? 'md:ml-auto' : 'md:mr-auto'} w-full md:w-[45%] pl-8 md:pl-0`}>
